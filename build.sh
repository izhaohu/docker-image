...
docker build --force-rm --compress -t registry.cn-shanghai.aliyuncs.com/vsi-open/"${NAME}:${VERSION}" .
...
docker push registry.cn-shanghai.aliyuncs.com/vsi-open/"${NAME}:${VERSION}"
